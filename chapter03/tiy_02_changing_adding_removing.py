...
print("sorry guys, something come up, i can invite only 2 people")
del guest_list[0]
del guest_list[0]

guest_list.remove("Hugo")
guest_list.remove("Gabriela")

print("the last person i remove is : " ,guest_list.pop())
print(guest_list)
